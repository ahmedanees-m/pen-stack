"""Writer-verification: score/critique, never invent. CI-safe (frozen panel
...
def test_critique_flags_a_bad_candidate_and_never_claims_it_works():
    ...
    assert c["no_claim"] is True and c["claimable"] is False # the verifier never asserts a generated writer works
