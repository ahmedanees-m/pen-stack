...
def test_groundedness_benchmark_meets_gates():
    # (re-scoped v7.1.1): citation coverage on the CITED answers, 0 unsupported, 0 false-grounding,
...
def test_safety_benchmark_meets_gates():
    # (re-scoped v7.1.1): false-grounding is THE headline; general questions are answered;
...
def test_headtohead_result_reframed_punchline():
    # punchline (committed LIVE result; re-framed v7.1.1): all three answer general questions, but only
