"""Regression: no hand-set per-enzyme score overrides remain in the scoring path.

The prior pipeline injected per-enzyme axis values (e.g. for ISCro4) to make gates pass. The current pipeline forbids
