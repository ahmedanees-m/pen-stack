...
def test_stage_h_surfaces_a_wellformed_ood_widen_field(monkeypatch):
    """Regression (tester finding, App_testing_debugging.txt + v7.3.14): the tester could not surface ANY OOD
    ...
    # the field the UI surfaces is present and well-formed for both contexts (the actual 7.3.14 regression)
