"""Bridge-recombinase off-target engine + QC.
...
2-mismatch site, while Hamming scores them identically. Fold/cross-loop QC and the integration hook are also
...
def test_bridge_hook_engine_ready():
