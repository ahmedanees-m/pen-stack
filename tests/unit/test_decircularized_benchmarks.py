"""De-circularized benchmark validators.

Skip the data-dependent checks when the writability atlas is absent (CI). The intent-specification
...
def test_writer_recovery_beats_prevalence():
    ...
    # recovery@1 is now < 1.0 by design (non-minimal-capacity choices like twinPE / phiC31)
...
def test_blind_gsh_discovery_scaled():
    ...
    # Signal: writability beats the safety baseline; the all-loci CI lower bound is above chance.
