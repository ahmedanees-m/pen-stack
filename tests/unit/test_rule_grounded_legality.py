"""Bench T12 rule-grounded legality + agent-uses-verifier. CI-safe."""
...
def test_agent_submits_plan_to_verifier():
    # the agent attaches a verification verdict; without the writability atlas it refuses upstream (verification
