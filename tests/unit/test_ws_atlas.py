"""Mesh-upgraded atlas unit tests (parity when oracles deferred, OOD-gated) +
...
def test_revalidate_reports_parity_when_oracles_deferred():
    ...
    # offline/CI: oracle backends deferred -> features unchanged -> parity vs the prior release, never hidden
