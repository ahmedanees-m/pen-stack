...
low-confidence ones?). The honest expectation: low-confidence plans (capacity-infeasible) are *never* the
    ...
    report = {
        ...
        "interpretation": (
            ("USEFUL FOR RANKING: high-confidence plans recover the documented writer choice more often than "
             "low-confidence ones (selective-prediction gap CI excludes 0). HONEST CAVEAT: absolute "
        ...
        "scope": "outcome = match to a DOCUMENTED real-world choice (survivorship-biased, small N: "
                 ...
                 "confidence is calibrated but marginal; NOT a clinical endpoint. Wide CIs are honest.",
        "no_fabrication": True,
    }
