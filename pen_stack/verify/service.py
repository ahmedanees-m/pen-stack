...
def verify(design: Design | dict, question: str | None = None, *, actor: str = "anonymous") -> Verdict:
    ...
    # v5.7: the safety gate is the first thing every caller inherits.
    ...
    # v4.0: if the design carries a GENERATED candidate writer sequence, critique it (fold / active
    ...
    # v5.1: if the design names a delivery vehicle, surface its DOCUMENTED ordinal immune/safety/
    ...
    # v5.4: if a cargo SEQUENCE is supplied, compute its innate-sensing load from sequence
    ...
    # v5.6: the unified per-axis immune-risk profile (genotox / CD8 epitope / innate / pre-existing
