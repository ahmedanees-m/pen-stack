...
class Verdict(BaseModel):
    ...
    writer_critique: dict[str, Any] | None = None # v4.0: critique of a generated candidate writer
                                                     # (pass/flag + reasons); NEVER a claim that it works
    delivery_profile: dict[str, Any] | None = None # v5.1: documented ordinal immune/safety/efficacy
                                                     # priors for the chosen vehicle (NEVER a predicted magnitude)
    immune_profile: dict[str, Any] | None = None # v5.6: per-axis immune-risk vector (genotox/CD8/
