...
ask "what can you do, and what do you refuse to answer?" and get a typed, honest answer it can route on. The
honesty machinery becomes an API, versioned under the 1.0 stability commitment.
"""
