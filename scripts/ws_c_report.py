"""Consolidated report - AlphaGenome sequence features + 3D structural risk.
...
def build() -> str:
    lines = [
        "# PEN-STACK v3.1 - AlphaGenome integration",
        "",
    ...
    lines += [
        ...
        "- Structural-risk flag: ships as a flag with confidence, never a hard pass/fail; heuristic, not a calibrated "
        ...
        "for on-demand track/3D signals and the endogenous-expression baseline.",
    ]
    return "\n".join(lines)
