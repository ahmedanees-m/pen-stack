"""Build the COMPUTED capsid T-cell-epitope-load oracle artifact.
...
fetched + verified from UniProt) so the run needs no network and is reproducible. Answers through the
