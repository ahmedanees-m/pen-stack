"""Reproducible analysis: the CELL-TYPE-MATCHED chromatin test that settled the prior ambiguous result.
...
RESULT (committed in benchmarks/offtarget/chromatin_validation.json, the phase2_hek293t_matched block): cell-type matching LIFTS the canonical
