...
`Verdict`; neither replaces the other.
...
- **sequence-homology screen** — delegated to a wrappable external screener (IBBIS Common Mechanism /
  SecureDNA-style); the in-repo baseline is an honest no-op (a safeguard, not a guarantee).
...
legitimate human-oversight pathway, HHS P3CO / DURC); a regulated *taxon* dominates to refuse.
