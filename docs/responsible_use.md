# Responsible use & the safety gate ("the Guardian")

PEN-STACK is built to help legitimate genome-writing science: gene therapy, cell engineering, synthetic
biology. **Every design submitted to `verify()` first passes a biosecurity / dual-use
...
The gate is **orthogonal** to the immune-risk profile: that asks *"will the patient react to this
