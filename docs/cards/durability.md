...
|---|---|---|---|
| expression Spearman ρ | **0.423** | (ATAC n/a) | ≥ 0.30 ✅ |
| silenced/stable AUROC | **0.643** | H3K9me3-only 0.578 | beats baseline ✅ |
...
## Known limitations
- Trained with **5 histone marks, no accessibility** (ES-Bruce4 lacks ATAC/DNase on mm10) — an honest partial
  panel; adding accessibility would likely raise ρ.
