# Data card: position-effect supervision
...
| Dataset | Citation | DOI | Accession | Cell types | Status |
|---|---|---|---|---|---|
...
- **Provenance:** same `trip_with_chromatin.parquet` the durability head trains on (regenerated by
