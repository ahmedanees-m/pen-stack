...
**Hybrid LLM (one switch, `configs/llm.yaml`).** The agent/RAG/monitor use a strong hosted model for
...
## Data
Mount the writability atlas (`atlas_<ct>.parquet`) under `./data/out/` (fetched from the Zenodo
