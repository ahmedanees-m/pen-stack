# Writer verification: the "better pen"

PEN-STACK does **not** invent writer enzymes de-novo. The earlier `pen-assemble` direction produced **0
validatable de-novo writers** and could not be checked computationally. This release builds the practical alternative:
...
axes, and a legal plan does not make an unverified candidate claimable.
