...
`cards/safety.md` — that scores a *locus*; this screens a *design* for dual-use hazard.)
...
(AI-homolog, split-hazard, reframing, chimera) **never `clear`**. The honest contrast is a **no-safety
