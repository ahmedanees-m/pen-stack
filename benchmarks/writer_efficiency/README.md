...
[Genome-Writing Challenge](../genome_writing_challenge/) for *how well a writer writes* (v6.8). Given
...
| Axis (n) | KB family-mean (MAE / ρ) | **learned model** (MAE / ρ) | MAE-reduction CI | learned wins? |
|---|---|---|---|---|
