...
def my_predict(public_input: dict):
    ...
    if public_input["family"] == "immune_risk":return "genotoxicity"  # highest-risk axis
...
|---|---|---|
| `legality` | a design | legal/illegal (from the validated rules) |
| `safety` | a design | clear/flag/escalate/refuse (from the Guardian) |
| `immune_risk` | a design | the highest-risk immune axis (from the profile) |
