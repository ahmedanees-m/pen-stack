"""Groundedness benchmark for the PEN-STACK chat.

The corrected framing: the chat ANSWERS general and social questions (labelled), grounds genome-writing questions in
the cited corpus, and abstains ONLY on a specific unsourceable empirical claim. The grounding metric is therefore
