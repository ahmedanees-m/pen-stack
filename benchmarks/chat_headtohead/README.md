# Chat Head-to-Head (re-framed v7.1.1)
...
answers the question); the differentiator is whether they tell you *what kind* of answer it is, and whether they invent a
...
|---|---|---|
| **PEN-STACK chat** | **1.00** | **0.00** |
| vanilla RAG | 0.00 | 0.67 |
| ungrounded LLM | 0.00 | 0.67 |

- **provenance_labelled_rate** - every PEN-STACK chat answer carries its lane + provenance (general / literature-cited /
...
- **fabricated_stat_on_unsourceable_rate** - asked for a specific number about a made-up writer/locus, the PEN-STACK chat
...
The claim is: the PEN-STACK chat answers general questions like any assistant, but it never presents an unsourced
