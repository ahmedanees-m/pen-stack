"""TPE-Bench, the position-effect / expression track for the Genome-Writing Challenge.
...
baseline leaderboard (cassette-only, context-only durability head, factored model). Two tracks:
...
factored model anchors the leaderboard. The public input shows chromatin context + cassette, never the label.
"""
