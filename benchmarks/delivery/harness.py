"""Delivery-Bench, the capsid-fitness track for the Genome-Writing Challenge.
...
learned model (windowed one-hot gradient boosting) must BEAT a mutation-burden baseline.
