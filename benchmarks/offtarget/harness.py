"""Off-Target-Bench, the nomination track for the Genome-Writing Challenge.
...
the validated off-targets surface first. The engine must BEAT a sequence-homology baseline (mismatch
