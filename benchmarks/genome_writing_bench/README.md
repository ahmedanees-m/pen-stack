...
2. **No circular labels.** The targeted-intent recovery@k was *definitional* (an
...
Tasks that need the writability atlas (Zenodo), the copyrighted Perry 2025 tables (local), or an LLM
