...
- **No circular labels.** Submissions inherit the no-circular-labels rule: no task may be scored against a definitional label
...
bench version and is announced in the release notes. Submissions are tagged with the bench version they ran on.
