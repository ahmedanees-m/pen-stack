# PA-WS3 — GSH-recovery enrichment

**Prereg:** [`prereg/ws_priorart.yaml`](../../../prereg/ws_priorart.yaml) `analysis_WS3`
(SHA-locked `33fb67b8…`; the frozen coordinate sets were hashed *before* the atlas lookup). **Gate:** PA-G2.
...
(p_durable AUROC 0.31 — oncogenes are transcriptionally active, hence *more* durable), consistent with PA-WS1-A
