# PEN-STACK Web Platform

The human surface for genome writing: a **grounded co-scientist** chat plus structured feature pages, over the
same typed API the AI surface uses. The LLM narrates and routes; the **engine sources every number**, and a
...
Experiments · Challenge · Scope & About, each calls the typed API and renders through the UX component
