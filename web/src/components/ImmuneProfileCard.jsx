...
// Writer Atlas page, where the writer is chosen, so this delivery-immunity card shows only the vehicle/
  ...
  return (
    <div>
      ...
      {/* writer-as-antigen: which writer enzyme drove the MHC-II/ADA axes, and whether it is the dominant antigen.
          Hidden here when the writer axes live on the Writer Atlas; shown for API callers that pass a writer. */}
