...
export default function CoScientist({ onBackend, allowLlm }) {
  ...
  async function send(text) {
    ...
    if (!q || busy) return;
    setInput("");
    // carry each turn's lane + provenance so a follow-up resolves against the prior answer's grounding.
...
// Chat v7.1: every lane carries its own provenance, including the new retrieval-grounded / abstained / refused
