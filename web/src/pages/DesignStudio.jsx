...
export default function DesignStudio() {
  ...
  // multiplex plan (opt-in, v7.3.8): 2-5 simultaneous edits, sent as design.edits so Verify can trigger the
  ...
  // Capsid packaging fitness (v6.11): learned FLIP-AAV model over an AAV VP1; AAV-only, abstains for other vectors
  ...
  // v6.11 serotype <-> tissue tropism (grounded in approved AAV therapies)
...
, otherwise the main dropdown moves the highlight while the numbers below stay stale. */}
      ...
      {/* Serotype -> tissue tropism (v6.11): grounded priors from FDA/EMA-approved AAV gene therapies */}
      ...
      {/* Capsid packaging fitness (v6.11): learned FLIP-AAV model, does a given capsid VP1 package/assemble? */}
