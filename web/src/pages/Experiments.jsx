...
export default function Experiments() {
  ...
  return (
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <Card title="Validation campaign" subtitle="The first campaign that points active learning at the measurements which would earn the program's first outcome-validated axis. A candidate plan, not a result; the wet run is the standing bottleneck.">
