  ...
  return (
    <Card title="position-effect model" subtitle="Which learned head served this design, and at what validation resolution.">
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
        ...
        {/* Testing surfaced this and tempered the framing (tester found it usually reads ×3). THIS is the
...
export default function Twin() {
  ...
  async function run() {
    ...
    // atlas) resolution, so the resolution-aware flag reports outcome_validated:false until exact-site.
    ...
    <div className="space-y-4">
      ...
      <ScoreGuide
        ...
        caveats={[
          ...
          "The learned position-effect head is served at coarse 1 kb feature resolution; the human head's validated ρ≈0.57 regime needs exact-site per-locus features (serve-time extraction).",
        ]} />
      ...
      <Card title="Design & cell state" subtitle="The twin predicts a relative outcome conditioned on the cell state.">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Promoter (drives relative expression)">
            ...
            {/* tester finding: a tissue-specific promoter (e.g. TBG=liver) picked for a mismatched cell
        ...
        <div className="mt-3 rounded-lg border border-line bg-ink-900 p-3">
          ...
          {useChromatin && (
            <>
              ...
              {/* tester finding: the marks are documented normalized signal in [0,1] but the field
              ...
              <p className="mt-2 text-[11px] text-fg-faint">Served at coarse 1&nbsp;kb atlas resolution → the human K562
                head serves but the outcome-validated flag stays false (exact-site per-locus features
      ...
      <Card title="Predicted outcome" subtitle="A bounded estimate, not a clinical or phenotypic guarantee.">
        {busy ? <Spinner label="Predicting…" /> : error ? <ErrorNote error={error} /> : !res ? (
          ...
          <div className="space-y-4">
            ...
            {/* tester's exact confusion: this flag is the virtual-cell RESPONSE oracle's own scope
