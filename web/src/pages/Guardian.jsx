...
export default function Guardian() {
  ...
  const [conc, setConc] = useState(null); // the fixed labelled-probe-set concordance benchmark
  ...
  return (
    <div className="space-y-4">
      ...
      <Card title="Guardian verdict" subtitle="Refusal is a feature: hazardous designs stop here.">
        {busy ? <Spinner label="Screening…" /> : error ? <ErrorNote error={error} /> : !res ? (
          ...
          <div className="space-y-3">
            ...
            {/* an empty Cargo function box (+ no domains/taxon) also decides "clear" -- nothing was
            ...
            {/* does this specific decision agree with community standards? (in-design concordance, not a certification) */}
            {res.standards && (
      ...
      {/* the labelled-probe-set concordance benchmark, was computed but had no UI/API surface */}
